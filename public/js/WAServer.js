...
var Reporter = function(e) {
    ...
    function i() {
      !M || M.length <= 0 || (r("reportKeyValue", {
        dataArray: M
      }), M = [])
    }

    function a() {
      !P || P.length <= 0 || (r("reportIDKey", {
        dataArray: P
      }), P = [])
    }

    function s() {
      !x || x.length <= 0 || (r("systemLog", {
        dataArray: x
      }), x = [])
    }
    ...
    "function" == typeof logxx && logxx("reporter-sdk start"), r("getPublicLibVersion", {}, function(e) {
      try {
        C = e.version.appVersion + " " + e.version.libVersion
      } catch (e) {}
    });
    var F = "ios" === c(),
      N = ("devtools" === c(), function() {}),
      W = {
        ...
        slowReport: function(e) {
          var t = e.key,
            ...
            i = f.SlowValueType[t],
            a = Date.now();
          if (i && (r || !(a - j < w)) && !(Object.keys(L).length > A || (L[o] || (L[o] = 0), L[o]++, L[o] > S))) {
            j = a;
        ...
        speedReport: function(e) {
          var t = e.key,
            ...
            o = e.timeMark,
            r = e.force,
            i = f.SpeedValueType[t],
            a = Date.now(),
            s = 0,
            c = o.nativeTime;
          if (i && (r || !(a - (D[i] || 0) < m)) && o.startTime && o.endTime && (1 != i && 2 != i || c)) {
            n && (s = JSON.stringify(n).length), D[i] = a;
        ...
        reportKeyValue: function(e) {
          var t = e.key,
            n = e.value,
            o = e.force;
          f.KeyValueType[t] && (!o && Date.now() - I < g || (I = Date.now(), M.push({
        ...
        reportIDKey: function(e) {
          var t = e.id,
            n = e.key,
            o = e.force;
          f.IDKeyType[n] && (!o && Date.now() - O < y || (O = Date.now(), P.push({
            id: t ? t : F ? "356" : "358",
            key: f.IDKeyType[n],
            value: 1
          }), P.length >= d && a()))
        ...
        errorReport: function(e) {
          ...
          if (f.ErrorType[t]) {
            ...
            if (console.error(c), "undefined" != typeof window && "undefined" != typeof window.__webviewId__ ? WeixinJSBridge.publish("WEBVIEW_ERROR_MSG", {
              ...
              }) : W.triggerErrorMessage(c), !(Object.keys(B).length > T)) {
              var u = f.ErrorType[t] + "," + n.name + "," + encodeURIComponent(r) + "," + encodeURIComponent(n.stack) + "," + encodeURIComponent(C);
              B[u] || (B[u] = 0), B[u]++, "thirdScriptError" === t && B[u] > _ || B[u] > k || (W.reportIDKey({
                key: t
              }), W.reportKeyValue({
                key: "Error",
                value: u
        ...
        log: function(e, t) {
          e && "string" == typeof e && (!t && Date.now() - E < b || (E = Date.now(), x.push(e + ""), x.length >= h && s()))
        },
        submit: function() {
          Date.now() - R < v || (R = Date.now(), a(), i(), s())
        },
  ...
  wx = function(e) {
      ...
      L = {
        ...
        onAccelerometerChange: function(e) {
          I || ((0, u.invokeMethod)("enableAccelerometer", {
            enable: !0
          }), I = !0), E.push(Reporter.surroundThirdByTryCatch(e, "onAccelerometerChange"))
        },
        onCompassChange: function(e) {
          O || ((0, u.invokeMethod)("enableCompass", {
            enable: !0
          }), O = !0), R.push(Reporter.surroundThirdByTryCatch(e, "onCompassChange"))
        },
    ...
    function s(e) {
      ...
      o(e, t, function(t) {
        ...
        "function" == typeof a.beforeAll && a.beforeAll(t), n ? ("function" == typeof a.beforeSuccess && a.beforeSuccess(t), "function" == typeof r.success && r.success(t), "function" == typeof a.afterSuccess && a.afterSuccess(t)) : o ? (t.errMsg = t.errMsg.replace(e + ":cancel", e + ":fail cancel"), "function" == typeof r.fail && r.fail(t), "function" == typeof a.beforeCancel && a.beforeCancel(t), "function" == typeof r.cancel && r.cancel(t), "function" == typeof a.afterCancel && a.afterCancel(t), Reporter.triggerErrorMessage(t.errMsg), Reporter.reportIDKey({
          key: e + "_cancel"
        ...
        value: function(e, t) {
          function n() {
            l ? (this.action = {
              ...
              data: t,
              videoPlayerId: f[this.domId],
              type: e
            })
          }
          var o = this;
          "number" == typeof f[this.domId] ? n.apply(this) : d.on("videoPlayerInsert", function(e) {
            n.apply(o)
          })
        }
      }, {
  ...
  __appServiceEngine__ = function(e) {
    ...
    var y = {
      ...
      m = (t.getCurrentPage = function() {
        ...
        (0, c.publish)("appDataChange", o, [t]), (0, l.triggerAnalytics)("pageReady", e)
      })),
      w = function(e, t, n) {
        var o = void 0;
      ...
      T = function(e, t, n, o) {
        if ((0, c.info)("On app route: " + e), y.appRouteTime = Date.now(), "navigateTo" === o) f && _(f), d.hasOwnProperty(t) ? (0, c.error)("Page route 错误(system error)", "navigateTo with an already exist webviewId " + t) : w(e, t, n);
          ...
          if (h[0].webviewId === t) s ? f = h[0] : f.onShow();
            ...
            f = {
              ...
              route: e,
              page: u
            }, h = [f], u.onShow(), (0, l.triggerAnalytics)("enterPage", u)
          } else h = [], w(e, t, n)
      ...
      M = function(e) {
        ...
        var t = d[e],
          n = t.page;
        n.hasOwnProperty("onPullDownRefresh") && ((0, c.info)("Invoke event onPullDownRefresh in page: " + t.route), c.safeInvoke.call(n, "onPullDownRefresh"), (0, l.triggerAnalytics)("pullDownRefresh", n))
      },
      P = function(e, t) {
        var n = e,
          o = d[t],
